...
export default async function (hre: HardhatRuntimeEnvironment) {
    ...
    const newGreeting = "Pomoz boze";

    const aaFactory = new ethers.Contract(sanitizedConfig.AA_FACTORY_ADDRESS, factoryArtifact.abi, wallet);
    ...
    const pluginableAccountAddress = utils.create2Address(
        sanitizedConfig.AA_FACTORY_ADDRESS,
    ...
    await (
        await wallet.sendTransaction({
            ...
            // You can increase the amount of ETH sent to the account
