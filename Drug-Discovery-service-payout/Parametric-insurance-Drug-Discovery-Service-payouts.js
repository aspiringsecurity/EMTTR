if (
  ...
  throw Error("OPEN_WEATHER_API_KEY environment variable not set for. Get a free one: https://openweathermap.org/")
}

if (
  !secrets.worldWeatherApiKey ||
  secrets.worldWeatherApiKey ===
    "World Weather API key (Get a free one: https://www.worldweatheronline.com/weather-api/)"
) {
  throw Error(
