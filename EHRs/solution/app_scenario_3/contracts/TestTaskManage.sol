...
contract TestTaskManage is TaskManage {
    ...
    function testInitiateTask() public payable {
        ...
        task = Task({taskName: "", toolName: "",
                     ...
                     isCrossValidate: false, isFinished: false, timeStamp: 0});
        
        initiateTask("ADMET", 2, 0.05 ether, true);
    ...
    function testSubmitPlayerRequest() public {
        ...
        task = Task({taskName: "AI Computation", toolName: "ADMET",
                     ...
                     isCrossValidate: false, isFinished: false, timeStamp: 1537142012});
    ...
    function testCrossValidate() public {
        /* Initiate Task */
        task = Task({taskName: "AI Computation", toolName: "ADMET",
                     numPlayers: 0, maxPlayers: 2, playerSalary: 0.05 ether,
                     isCrossValidate: true, isFinished: true, timeStamp: 1537142012});
        isTaskInitialized = true;
        owner = msg.sender;
        /* Clean player pool */
        while (playerPool.length > 0)
        ...
        /* Initiate player */
        playerPool.push(Player(playerAddr, 1, 3, 0.5 ether, 4, now));
        playerPool.push(Player(playerAddr, 2, 4, 0.2 ether, 4, now));
        task.numPlayers = 2;
        
        uint bestId = crossValidate();
