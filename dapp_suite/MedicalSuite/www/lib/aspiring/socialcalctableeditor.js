...
SocialCalc.CreateTableEditor = function(editor, width, height) {
    ...
    /* We are running in IE -- Using HTML-based area for Ctrl-V */
                                  ...
                                  console.log("editAutoSave");
                                  SocialCalc.Callbacks.editAutoSave();
                                  autoSave(selectedFile, wval.ecoord);
                                  ...
                                  ///return newcell; // already there - don't do anything and don't tell anybody
                                  //}
                                  }
    ...
    /* IE 4+ - Safer than setting .selectionEnd as it also works for Textareas. */
                                  ...
                                  // check if a message box must be shown in the coord
    /* if (SocialCalc.Callbacks.mustshowprompt(coord))
     {
     SocialCalc.Callbacks.showprompt(coord);
     return;
     }*/
                                  //if(orientation == "landscape"){
                                  //console.log("prompt");
                                  ...
                                  //changes for prompt
    /*var inputtype = SocialCalc.Callbacks.getinputtype(coord);
     if (inputtype)
     {
     ...
     */
                                                                                  ...
                                                                                  //changes by mini for cut copy paste
                                                                                  
                                                                                  var fixcoord1="C38";
                                                                                  var fixcoord2="F38";
                                                                                  //var fixcoord3="D48";
                                                                                  
                                                                                  var k=fixcoord1.substring(1);
                                                                                  var j=k-1;
                                                                                  
                                                                                  var sh7fixcoord1="C28";
                                                                                  var sh7fixcoord2="F28";
                                                                                  var sh7fixcoord3="G28";
                                                                                  var sh7fixcoord4="H28";
                                                                                  
                                                                                  var sh7k=sh7fixcoord1.substring(1);
                                                                                  var sh7j=sh7k-1;
                                                                                  var tp2k=sh7k;
                                                                                  var tp2j=sh7j;
                                                                                  
                                                                                  var tp3fixcoord1="B39";
                                                                                  var tp3fixcoord2="G39";
                                                                                  //var tp3fixcoord3="G36";
                                                                                  var tp3k=tp3fixcoord1.substring(1);
                                                                                  var tp3j=tp3k-1;
                                                                                  
                                                                                  
                                                                                  
                                                                                  var tp4fixcoord1="B39";
                                                                                  var tp4fixcoord2="E39";
                                                                                  var tp4fixcoord3="F39";
                                                                                  var tp4fixcoord4="G39";
                                                                                  
                                                                                  //var tp3fixcoord3="G36";
                                                                                  var tp4k=tp4fixcoord1.substring(1);
                                                                                  var tp4j=tp4k-1;
                                                                                  
                                                                                  
                                                                                  var no_of_lines_copied=0;
                                                                                  
                                                                                  SocialCalc.EditorCut = function(editor, text,no_of_cells) {
                                                                                  //alert("Editorcut");
                                                                                  ...
                                                                                  var wval = editor.workingvalues;
                                                                                  var temp = wval.ecoord;//alert(temp+"");
                                                                                  wval.ecoord='C5';
                                                                                  //alert(wval.ecoord+"");
                                                                                  wval.ecoord=temp;
                                                                                  //alert(wval.ecoord+"");
                                                                                  ...
                                                                                  //for adsn of row
                                                                                  var actvsheet=editor.workingvalues.currentsheet;
                                                                                  
                                                                                  var editable=function(bool,crdnate){
                                                                                  var cellname = actvsheet+"!"+crdnate;
                                                                                  alert(cellname);
                                                                                  if(bool==1){
                                                                                  
                                                                                  SocialCalc.EditableCells.cells[cellname]="true";}
                                                                                  else
                                                                                  {SocialCalc.EditableCells.cells[cellname]=null;
                                                                                  }
                                                                                  };
                                                                                  
                                                                                  if(no_of_cells==1){
                                                                                  if(value=="a"){
                                                                                  //alert("cut coord "+editCoord);
                                                                                  cmdline = "cut "+editCoord+" all";no_of_lines_copied=1;
                                                                                  }
                                                                                  else if(value=="b"){cmdline = "copy "+editCoord+" all";no_of_lines_copied=1;
                                                                                  //alert("cut coord "+editCoord);
                                                                                  }
                                                                                  else if(value=="c"){cmdline = "paste "+editCoord+" all";
                                                                                  //alert("paste coord "+editCoord);alert("Paste");
                                                                                  }
                                                                                  else if(value=="d"){cmdline = "erase "+editCoord+" formulas";}
                                                                                  else if(value=="g"){alert('editable');editable(1,"G35");cmdline = "deleterow G35";editor.EditorScheduleSheetCommands(cmdline, true, false);alert('entered delete');}
                                                                                  else if(value=="h"){editable(1,"G36");cmdline = "insertrow G36";editor.EditorScheduleSheetCommands(cmdline, true, false);alert('done till insert');
                                                                                  cmdline = "set G36 value n 25";alert('setting value=25');editor.EditorScheduleSheetCommands(cmdline, true, false);editable(0,"G36");
                                                                                  }
                                                                                  else if(value=="e"){
                                                                                  
                                                                                  cmdline = "deleterow "+wval.ecoord;
                                                                                  if(actvsheet=="typei"){
                                                                                  k--;
                                                                                  j--;
                                                                                  
                                                                                  var vcoord1=fixcoord1.substring(0,1).concat(k);
                                                                                  var vcoord2=fixcoord2.substring(0,1).concat(k);
                                                                                  
                                                                                  editable(0,vcoord1);
                                                                                  editable(0,vcoord2);}
                                                                                  
                                                                                  else if(actvsheet=="typeii"){
                                                                                  sh7k--;
                                                                                  sh7j--;
                                                                                  var vcoord1=sh7fixcoord1.substring(0,1).concat(sh7k);
                                                                                  var vcoord2=sh7fixcoord2.substring(0,1).concat(sh7k);
                                                                                  var vcoord3=sh7fixcoord3.substring(0,1).concat(sh7k);
                                                                                  var vcoord4=sh7fixcoord4.substring(0,1).concat(sh7k);
                                                                                  ...
                                                                                  else if(actvsheet=="typeiii"){
                                                                                  tp2k--;
                                                                                  tp2j--;
                                                                                  var vcoord1=tp3fixcoord1.substring(0,1).concat(tp2k);
                                                                                  var vcoord2=tp3fixcoord2.substring(0,1).concat(tp2k);
                                                                                  ...
                                                                                  alert('entering');
                                                                                  var sheetid="typeiii";
                                                                                  var cmdstr = "set B15 text t ashish"
                                                                                  var control = SocialCalc.GetCurrentWorkBookControl();
                                                                                  ...
                                                                                  else if(actvsheet=="typeiv"){
                                                                                  tp4k--;
                                                                                  tp3j--;
                                                                                  
                                                                                  var vcoord1=tp3fixcoord1.substring(0,1).concat(tp3k);
                                                                                  var vcoord2=tp3fixcoord2.substring(0,1).concat(tp3k);
                                                                                  var vcoord21=tp3fixcoord2.substring(0,1).concat(tp3k+4);
                                                                                  var vcoord3=tp3fixcoord3.substring(0,1).concat(tp3k);
                                                                                  var vcoord31=tp3fixcoord3.substring(0,1).concat(tp3k+1);
                                                                                  var vcoord32=tp3fixcoord3.substring(0,1).concat(tp3k+2);
                                                                                  var vcoord33=tp3fixcoord3.substring(0,1).concat(tp3k+3);
                                                                                  var vcoord34=tp3fixcoord3.substring(0,1).concat(tp3k+4);
                                                                                  
                                                                                  var v1=tp3k+2;
                                                                                  var v2=tp3k+5;
                                                                                  var vcoord11=tp3fixcoord1.substring(0,1).concat(v1);
                                                                                  var vcoord12=tp3fixcoord1.substring(0,1).concat(v2);
                                                                                  ...
                                                                                  editable(1,vcoord2);
                                                                                  editable(0,vcoord21);
                                                                                  editable(0,vcoord3);editable(1,vcoord31);editable(0,vcoord32);editable(1,vcoord33);editable(0,vcoord34);
                                                                                  }
                                                                                  }
                                                                                  else if(value=="f"){
                                                                                  cmdline = "insertrow "+wval.ecoord;
                                                                                  if(actvsheet=="typei"){	j++;
                                                                                  k++;
                                                                                  var vcoord1=fixcoord1.substring(0,1).concat(j);
                                                                                  var vcoord2=fixcoord2.substring(0,1).concat(j);
                                                                                  editable(1,vcoord1);
                                                                                  editable(1,vcoord2);}
                                                                                  
                                                                                  
                                                                                  else if(actvsheet=="sheet7"){
                                                                                  sh7k++;
                                                                                  sh7j++;
                                                                                  
                                                                                  var vcoord1=sh7fixcoord1.substring(0,1).concat(sh7j);
                                                                                  var vcoord2=sh7fixcoord2.substring(0,1).concat(sh7j);
                                                                                  var vcoord3=sh7fixcoord3.substring(0,1).concat(sh7j);
                                                                                  ...
                                                                                  var vcoord1=sh7fixcoord1.substring(0,1).concat(tp2j);
                                                                                  var vcoord2=sh7fixcoord2.substring(0,1).concat(tp2j);
                                                                                  var vcoord3=sh7fixcoord3.substring(0,1).concat(tp2j);
                                                                                  ...
                                                                                  var vcoord1=tp3fixcoord1.substring(0,1).concat(tp3j);
                                                                                  //var vcoord2=tp3fixcoord2.substring(0,1).concat(tp3j+4);
                                                                                  var vcoord3=tp3fixcoord3.substring(0,1).concat(tp3j);
                                                                                  //var vcoord31=tp3fixcoord3.substring(0,1).concat(tp3j+1);
                                                                                  //var vcoord32=tp3fixcoord3.substring(0,1).concat(tp3j+2);
                                                                                  //var vcoord33=tp3fixcoord3.substring(0,1).concat(tp3j+3);
                                                                                  //var vcoord34=tp3fixcoord3.substring(0,1).concat(tp3j+4);
                                                                                  ...
                                                                                  editable(1,vcoord1);
                                                                                  editable(1,vcoord2);
                                                                                  editable(1,vcoord3);//editable(0,vcoord31);editable(1,vcoord32);editable(0,vcoord33);editable(1,vcoord34);
                                                                                  }
                                                                                  
                                                                                  }
                                                                                  }
                                                                                  else if (no_of_cells>1)
                                                                                  {
                                                                                  
                                                                                  var str = wval.ecoord;
                                                                                  
                                                                                  no_of_cells--;
                                                                                  //var res = str.substring(1)-0+no_of_cells;
                                                                                  
                                                                                  //res =str.substring(0,1).concat(res);
                                                                                  var res = str.substring(1)-0;
                                                                                  
                                                                                  //var res = str.substring(1)-0+no_of_cells;
                                                                                  
                                                                                  //res =str.substring(0,1).concat(res);
                                                                                  var cname=actvsheet+"!"+str;
                                                                                  //var cellinner = document.getElementById("cell_"+cname);
                                                                                  alert(cname);
                                                                                  var count=0;
                                                                                  var isempty=0;
                                                                                  while(1){
                                                                                  if(SocialCalc.EditableCells.cells[cname]) {
                                                                                  var cellinner = document.getElementById("cell_"+str.substring(0,1).concat(res));
                                                                                  if(cellinner.innerHTML != "&nbsp;"){isempty++;alert(cellinner.innerHTML);}
                                                                                  
                                                                                  count++;res++;cname=actvsheet+"!"+str.substring(0,1).concat(res);alert(cname);
                                                                                  ...
                                                                                  cmdline = "cut "+wval.ecoord+":"+res+" all";no_of_lines_copied=count+1;alert(no_of_lines_copied);
                                                                                  }
                                                                                  else if(value=="b"){cmdline = "copy "+wval.ecoord+":"+res+" all";no_of_lines_copied=count+1;alert(no_of_lines_copied);
                                                                                  alert("Copied");}
                                                                                  else if(value=="c"){
                                                                                  var r=true;
                                                                                  if(isempty>0) {r=confirm("Do you wish to over write the data");}
                                                                                  if(r==true){
                                                                                  
                                                                                  if(no_of_lines_copied>count+1){alert("Can't paste here.More rows required!");}
                                                                                  else {cmdline = "paste "+wval.ecoord+":"+res+" all";} }
                                                                                  
                                                                                  
                                                                                  }
                                                                                  else if(value=="d"){cmdline = "erase "+wval.ecoord+":"+res+" formulas";}
                                                                                  
                                                                                  }
                                                                                  
                                                                                  
                                                                                  if(value!="g" && value!="h"){editor.EditorScheduleSheetCommands(cmdline, true, false);
                                                                                  var str="";
                                                                                  switch(value){
                                                                                  case "a": str="Cut";
                                                                                  break;
