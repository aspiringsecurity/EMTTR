...
applicationName = "Medication Dose Schedule";
...
function showPrintDialog(){
    ...
    cordova.plugins.printer.print(html, 'MedicationDoseSchedule.html', function () {
...
function exportAsCsv(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function(fileSystem) {
                             ...
                             //alert("fs");
                             fileSystem.root.getFile("MedicationDoseSchedule.csv", {create: true}, function(entry) {
                                                     var fileEntry = entry;
                                                     console.log(entry);
...
function sendAttachmentCsv(content){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Medication Dose Schedule',
                                                        body: content,
                                                        isHtml: true,
                                                        attachments: [
                                                                      ...
                                                                      encoding: 'UTF-8',
                                                                      data: content,
                                                                      name: 'MedicationDoseSchedule.csv'
                                                                      }],
...
function cloudInappSuccess(){
    ...
    $.ajax({
           ...
           data: {action:"purchase",appname:"Medication Dose Schedule"},
           dataType: 'json',
           success: function(response) {
...
function setCloudRestoreItems(products){
    ...
    /*$.ajax({
           type: 'POST',
           url: 'http://aspiringapps.com/restore',
           data: {content:products,action:"inapp",appname:"Medication Dose Schedule"},
           dataType: 'json',
           success: function(response) {
           ...
           //showToast("Please Login to access Medication Dose Schedule on web");
...
function checkBeforeSave(file){
    ...
    if(products[0].Purchase == "Yes"){
        ...
        navigator.notification.alert("Save as exhausted.Kindly purchase by clicking on the Purchase Tab",null,"Medication Dose Schedule Widget");
...
function saveToWeb(file){
    ...
    var interval = setInterval(function(){
                               ...
                               request(messages, function(result){
                                       ...
                                       message.type="POST";
                                       message.format = 'json';
                                       message.data={action:"savefile",fname:fname,data:val1,appname:"Medication Dose Schedule"};
...
function updateCloudInapp(){
    ...
    message.type="POST";
    message.format = 'json';
    message.data={action:"update",appname:"Medication Dose Schedule"};
...
function showFeedback(){
    cordova.require('emailcomposer.EmailComposer').show({
                                                        ...
                                                        cc: '',
                                                        bcc: '',
                                                        subject: 'Medication Dose Schedule: Please share your feedback',
                                                        body: '',
                                                        isHtml: true,
                                                        onSuccess: function (winParam) {
                                                        console.log('EmailComposer onSuccess - return code ' + winParam.toString());
...
function refer(){
    ...
    var onConfirm = function(buttonIndex){
        if(buttonIndex == 4) return;
            ...
            window.plugins.socialsharing.shareViaFacebook('Medication Dose Schedule  using Medication Dose Schedule', 'www/img/bi.png' /* img */, 'https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#' /* url */, function() {
                                                          console.log('share ok');
                                                          },
                                                          function(errormsg){console.log(errormsg)});
            ...
            window.plugins.socialsharing.shareViaTwitter('Medication Dose Schedule  using Medication Dose Schedule','www/img/bi.png','https://itunes.apple.com/us/app/medication-log/id894930232?ls=1&mt=8#');
        }
    ...
    navigator.notification.confirm(
                                   'Refer Medication Dose Schedule via', // message
                                   onConfirm,  // callback to invoke with index of button pressed
...
function checkBeforeUse(feature,name){
    ...
    if(feature == "email"){
        ...
        cordova.require('emailcomposer.EmailComposer').show({
                                                            ...
                                                            cc: '',
                                                            bcc: '',
                                                            subject: 'Medication Dose Schedule Workbook',
                                                            body: content,
                                                            isHtml: true,
                                                            attachments: [{
                                                                          mimeType: 'text/html',
                                                                          encoding: 'UTF-8',
                                                                          data: content,
                                                                          name: 'MedicationDoseSchedule.html'
                                                                          }],
