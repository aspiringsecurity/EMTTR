...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Medication Dose Schedule"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Medication Dose Schedule"};
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Medication Dose Schedule"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('App', function() {
         ...
         footerList = [{
                       index: 1,
                       name: 'Medication Dose Schedule 1'
                       }, {
                       index: 2,
                       name: 'Medication Dose Schedule 2'
                       },{
                       index: 3,
                       name: 'Medication Dose Schedule 3'
                       },{
                       index: 4,
                       name: 'Medication Dose Schedule 4'
                       },{
                       index: 5,
                       name: 'Medication Dose Schedule 5'
                       },{
                       index: 6,
                       name: 'Medication Dose Schedule 6'
                       }];
         }
...
.factory('Items',function(){
         ...
         desc = "Medication Dose Schedule Web Widget";
...
.factory('ModalService',function($ionicModal, $timeout, CloudService){
         ...
         var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Medication Dose Schedule"};
         ...
         CloudService.request(message).then(function(response){
                                            ...
                                            var message = {action:"getInapp",appname:"Medication Dose Schedule"};
         ...
         var message={action:"register",uuid:uuid,password:pass,appname:"Medication Dose Schedule"};
