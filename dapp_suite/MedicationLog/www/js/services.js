...
.factory('CloudService', function($http){
         ...
         $http.get("http://aspiringapps.com/webapp",{params:{action:"getInapp",appname:"Medication Log"}}).
         success(function(response) {
                 ...
                 var message = {action:"update",appname:"Medication Log"};
         ...
         $http.get("http://aspiringapps.com/restore",{params:{action:"getInapp",appname:"Medication Log"}}).
         success(function(response) {
                 // this callback will be called asynchronously
                 // when the response is available
                 var result = response.result;
...
.factory('App', function() {
         ...
         footerList = [{
                       index: 1,
                       name: 'Medication Log 1'
                       }, {
                       index: 2,
                       name: 'Medication Log 2'
                       },{
                       index: 3,
                       name: 'Medication Log 3'
                       },{
                       index: 4,
                       name: 'Medication Log 4'
                       },{
                       index: 5,
                       name: 'Medication Log 5'
                       },{
                       index: 5,
                       name: 'Medication Log 6'
                       }];
         }
...
.factory('Items',function(){
         ...
         desc = "Medication Log Web Widget";
...
.factory('ModalService',function($ionicModal, $timeout, CloudService){
         ...
         var message = {action:"login",uuid:uuid,password:pass,deviceId:device.uuid,appname:"Medication Log"};
         ...
         CloudService.request(message).then(function(response){
                                            ...
                                            var message = {action:"getInapp",appname:"Medication Log"};
         ...
         var message={action:"register",uuid:uuid,password:pass,appname:"Medication Log"};
